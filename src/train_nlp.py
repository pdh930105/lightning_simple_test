...
def train(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    dm: LightningDataModule = hydra.utils.instantiate(cfg.datamodule, model_name_or_path=cfg.model.model_name_or_path)
    dm.setup("fit")
    log.info(f"Instantiating model <{cfg.model._target_}>")
    model: LightningModule = hydra.utils.instantiate(cfg.model, task_name=dm.task_name, num_labels=dm.num_labels, eval_splits=dm.eval_splits)
